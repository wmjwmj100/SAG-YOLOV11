...
class DETRLoss(nn.Module):
    ...
    Attributes:
        ...
        use_uni_match (bool): Whether to use a fixed layer for auxiliary branch labels assignment.
    ...
    def __init__(
        ...
        Args:
            ...
            use_fl (bool): Whether to use FocalLoss.
            use_vfl (bool): Whether to use VarifocalLoss.
            use_uni_match (bool): Whether to use fixed layer for auxiliary branch labels assignment.
