...
def create_synthetic_coco_dataset():
    """
    Create a synthetic COCO dataset with random images based on filenames from labels lists.

    This function downloads COCO labels, reads image filenames from labels list files,
    ...
    Notes:
        - Requires internet connection to download labels files.
    ...
    with ThreadPoolExecutor(max_workers=NUM_THREADS) as executor:
        for subset in {"train2017", "val2017"}:
            ...
            # Read image filenames from labels list file
