...
class YOLODataset(BaseDataset):
    ...
    Methods:
        ...
        update_labels_info: Update labels format for different tasks.
    ...
    def get_labels(self) -> List[Dict]:
        ...
        Returns:
            (List[dict]): List of labels dictionaries, each containing information about an image and its annotations.
        """
    ...
    def update_labels_info(self, label: Dict) -> Dict:
        """
        Update labels format for different tasks.

        Args:
            label (dict): Label dictionary containing bboxes, segments, keypoints, etc.

        Returns:
            (dict): Updated labels dictionary with instances.
...
class YOLOMultiModalDataset(YOLODataset):
    ...
    def update_labels_info(self, label: Dict) -> Dict:
        ...
        Returns:
            (dict): Updated labels dictionary with instances and texts.
        """
...
class GroundingDataset(YOLODataset):
    ...
    def verify_labels(self, labels: List[Dict[str, Any]]) -> None:
        ...
        Args:
            labels (List[Dict[str, Any]]): List of labels dictionaries, where each dictionary
                contains dataset annotations. Each labels dict must have a 'bboxes' key with
