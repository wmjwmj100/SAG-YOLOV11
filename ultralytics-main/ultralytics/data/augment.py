...
class BaseTransform:
    ...
    Methods:
        ...
        __call__: Apply all labels transformations to an image, instances, and semantic masks.
    ...
    def __call__(self, labels):
        """
        Apply all labels transformations to an image, instances, and semantic masks.
...
class BaseMixTransform:
    ...
    Methods:
        ...
        _update_label_text: Update labels text for mixed images.
    ...
    def __call__(self, labels):
        ...
        Args:
            labels (dict): A dictionary containing labels data for an image.
    ...
    def _mix_transform(self, labels):
        """
        Apply CutMix, MixUp or Mosaic augmentation to the labels dictionary.
        ...
        Args:
            labels (dict): A dictionary containing image and labels data. Expected to have a 'mix_labels' key
                with a list of additional image and labels data for mixing.
    ...
    def _update_label_text(labels):
        """
        Update labels text and class IDs for mixed labels in image augmentation.
...
class Mosaic(BaseMixTransform):
    ...
    def _mosaic3(self, labels):
        ...
        Args:
            labels (dict): A dictionary containing image and labels information for the main (center) image.
    ...
    def _update_labels(labels, padw, padh):
        """
        Update labels coordinates with padding values.
    ...
    def _cat_labels(self, mosaic_labels):
        ...
        Args:
            mosaic_labels (List[Dict]): A list of labels dictionaries for each image in the mosaic.
...
class MixUp(BaseMixTransform):
    ...
    def _mix_transform(self, labels):
        ...
        Args:
            labels (dict): A dictionary containing the original image and labels information.

        Returns:
            (dict): A dictionary containing the mixed-up image and combined labels information.
...
class LoadVisualPrompt:
    ...
    def get_visuals(self, category, shape, bboxes=None, masks=None):
        ...
        if bboxes is not None:
            ...
            raise ValueError("LoadVisualPrompt must have bboxes or masks in the labels")
