...
class BaseDataset(Dataset):
    ...
    Attributes:
        ...
        labels (List[Dict]): List of labels data dictionaries.
    ...
    Methods:
        ...
        get_image_and_label: Get and return labels information from the dataset.
        update_labels_info: Custom labels format method to be implemented by subclasses.
    ...
    def __getitem__(self, index: int) -> Dict[str, Any]:
        """Return transformed labels information for given index."""
